...
<%
	...
	if(OperatorID==null){
		session.setAttribute("visitPage","report_yskcx.jsp");
		response.setContentType("text/html; charset=UTF-8");
		response.sendRedirect("login.jsp");
	}else{
		boolean valid =AuthUtil.checkValid(OperatorID,"yskcx");
		if(!valid){
			session.setAttribute("visitPage","report_yskcx.jsp");
			response.setContentType("text/html; charset=UTF-8");
	...
	<body>
		<div data-role="page" id="pageHome">
			<div data-role="navbar" id="navigationBar">
				<ul>
					<li><a id="nav_query" data-ajax="false" class="ui-btn-active">应收款</a></li>
			...
			<div id="queryPart" class="ui-body-d ui-content" data-theme="b">
				<form method="post">					
					...
					<div class="ui-field-contain">
						<label><input id="baohanyushouyufu" name="baohanyushouyufu" type="checkbox">包含预收</label>
					</div>
					<br/>
