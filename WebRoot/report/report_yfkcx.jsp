...
<html>
	...
	<script type="text/javascript">
		...
		function sendForSupplyUnit(supplyUnitCode,pageNum,backCall){
			var organization =  $("#jigou").data("orgCode");
			var requestData = "action=action_wlzmb_yfkcx_unit&OperatorID=<%=OperatorID%>&organization="+organization+"&pageNum=1&itemsInEachPage=5"
			if(typeof(pageNum)!="undefined" && typeof(supplyUnitCode)!="undefined"){
				requestData = "action=action_wlzmb_yfkcx_unit&OperatorID=<%=OperatorID%>&organization="+organization+"&pageNum="+pageNum+"&itemsInEachPage=5&supplyUnitCode="+supplyUnitCode
			}
			$.ajax({
				url: contextPath+"/BusinessServlet",
				data: requestData,
